...
public class AllFeedsAdapter extends RecyclerView.Adapter<AllFeedsAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView comment_one_text,post,feed_date,profile_name,feed_des,like_count,comment_count,comment_one_like_count
                ,comment_one_time,comment_two_text,comment_two_like_count,comment_two_time, like_pray_fix,feed_blog_url;
        ...
        public MyViewHolder(View view) {
            ...
            feed_blog_url_llayout=view.findViewById(R.id.feed_blog_url_llayout);
            feed_blog_url=view.findViewById(R.id.feed_blog_url);
...
//        poss=position;
        ...
        if (feedList.get(position).getBlog_url().equals(""))
        {
            holder.feed_blog_url_llayout.setVisibility(View.GONE);
        }
        else
        {
            holder.feed_blog_url_llayout.setVisibility(View.VISIBLE);
            holder.feed_blog_url.setText(feedList.get(position).getBlog_url());

        }
        holder.feed_blog_url.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                Intent intent=new Intent(mContext, SettingActivity.class);
//                mContext.startActivity(intent);
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(feedList.get(position).getBlog_url()));
        ...
        if(chk_like_count == 0 && chk_comment_count == 0){
            ...
            if(chk_like_count == 0){
                ...
                if (feedList.get(position).isAdmin_quote()){
                    ...
                    holder.likecount_img_fix.setImageResource(R.drawable.app_icon_);
...
//                    bounce animation------------------------------------------------------
                        ...
                        holder.like_heart_img.setImageResource(R.drawable.app_icon_);
                        holder.like_pray_fix.setText("Prayed");
                        holder.like_pray_fix.setTextColor(Color.parseColor("#109d58"));
...
//                    Toast.makeText(mContext, "welcome", Toast.LENGTH_SHORT).show();
            ...
            holder.share_rel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent sendIntent = new Intent();
                    sendIntent.setAction(Intent.ACTION_SEND);
                    sendIntent.putExtra(Intent.EXTRA_TEXT, "Download Jokes book for fun " + feedList.get(position).getUser_fullname() + "\n" + feedList.get(position).getTitle());
                    sendIntent.setType("text/plain");
                    mContext.startActivity(sendIntent);
                    dialog.dismiss();
                    ...
                    menu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            ...
                            if(item.getTitle().equals("Save Image")){
                                ...
                                if (feedList.get(position).getLarge_image().equals(""))
                                {
...
//            if (downloadUrlOfImage.length()==0)
//            {
//                Toast.makeText(mContext, "No Image Attached ", Toast.LENGTH_SHORT).show();
//                return;
//            }
