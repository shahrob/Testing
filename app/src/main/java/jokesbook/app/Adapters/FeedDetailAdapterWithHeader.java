...
import jokesbook.app.Activity.SettingActivity;
...
import static jokesbook.app.Activity.FeedDetailedActivity.feed_detail_obj;
...
public class FeedDetailAdapterWithHeader extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView comment_text,comment_like_count,comment_time,feed_blog_url;
//        TextView date_reply;
        ImageView comment_heart_img;

        LinearLayout feed_blog_url_llayout;
...
//
            ...
            feed_blog_url_llayout=itemView.findViewById(R.id.feed_blog_url_llayout);
            feed_blog_url=itemView.findViewById(R.id.feed_blog_url);
    ...
    class VHHeader extends RecyclerView.ViewHolder {
        ...
        TextView feed_description,feed_profile_name,feed_profile_date,like_count,comment_count,feed_blog_url;
...
//                                        commentList.get(position).setLiked_count(commentList.get(position).getLiked_count()+1);
...
//           ////////////////////// Blog url work And blog_url_onclick work here/////////////////////////////


            if (feed_detail_obj.getFeed_blog_url().isEmpty())
            {
                ((VHHeader) holder).feed_blog_url_llayout.setVisibility(View.GONE);
            }
            else
            {
                ((VHHeader) holder).feed_blog_url_llayout.setVisibility(View.VISIBLE);
                ((VHHeader) holder).feed_blog_url.setText(feed_detail_obj.getFeed_blog_url());
            }
            ((VHHeader) holder).feed_blog_url_llayout.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
//                    Intent intent=new Intent(mContext,SettingActivity.class);
//                    mContext.startActivity(intent);
                    Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(feed_detail_obj.getFeed_blog_url()));
