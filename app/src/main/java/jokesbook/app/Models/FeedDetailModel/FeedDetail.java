package jokesbook.app.Models.FeedDetailModel;
...
public class FeedDetail {
    ...
    String feed_blog_url;

    public String getFeed_blog_url() {
        return feed_blog_url;
    }

    public void setFeed_blog_url(String feed_blog_url) {
        this.feed_blog_url = feed_blog_url;
    }
