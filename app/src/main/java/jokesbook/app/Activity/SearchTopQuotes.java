...
import jokesbook.app.Adapters.SearchTopQuotesAdapter;
...
import jokesbook.app.GridSpacingItemDecoration;
import jokesbook.app.Models.TopQuotes.TopQuotes;
...
public class SearchTopQuotes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeContainer_top.setColorSchemeColors(Color.parseColor("#9F0030"));
