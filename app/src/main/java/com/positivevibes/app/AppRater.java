...
public class AppRater {
    private final static String APP_TITLE = "Positive Vibes";// App Name
    private final static String APP_PNAME = "com.positivevibes.app";// Package Name
    ...
    public static void showRateDialog(final Context mContext, final SharedPreferences.Editor editor) {
        ...
        tv.setWidth(200);
        tv.setPadding(5, 20, 5, 10);
        ll.addView(tv);

        Button b1 = new Button(mContext);
        b1.setPadding(5,20,5,10);
